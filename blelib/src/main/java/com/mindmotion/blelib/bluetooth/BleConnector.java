package com.mindmotion.blelib.bluetooth;
...
import com.mindmotion.blelib.data.BleMsg;
import com.mindmotion.blelib.data.BleWriteState;
import com.mindmotion.blelib.exception.GattException;
import com.mindmotion.blelib.exception.OtherException;
import com.mindmotion.blelib.exception.TimeoutException;
...
public class BleConnector {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_DATA_CHANGE: {
                        BleNotifyCallback bleNotifyCallback = (BleNotifyCallback) msg.obj;
                        Bundle bundle = msg.getData();
    ...
    public void enableCharacteristicIndicate(BleIndicateCallback bleIndicateCallback, String uuid_indicate,
                                             boolean useCharacteristicDescriptor) {
        if (mCharacteristic != null
                && (mCharacteristic.getProperties() | BluetoothGattCharacteristic.PROPERTY_INDICATE) > 0) {
