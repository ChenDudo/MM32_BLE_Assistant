    ...
    private void initView() {
                    ...
                    BleManager.getInstance().write(bleDevice, "00000000-fc0a-4c04-9df8-245fc68a5036",
                            ...
                            new BleWriteCallback() {
                                ...
                                public void onWriteFailure(BleException exception) {
                                    //Toast.makeText(getApplicationContext(),"send ERR", Toast.LENGTH_SHORT).show();
                                }
                            }
                    );
        ...
        pwm.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                Log.d("Seekbar", "i: " + i);
                pwmValue.setText("PWM Value: "+ i * 10);
                pwmSendata = i * 10;
            }
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "退出后请断开再重新连接进入本页面", Snackbar.LENGTH_LONG)
